...
async def premium_command(client: Client, message: Message):
    ...
    try:
        # Route to premium info from start_handler
        from bot.plugins.start_handler import premium_info_callback
        ...
        await premium_info_callback(client, fake_query)
...
async def stats_command(client: Client, message: Message):
    ...
    try:
        # Route to user stats from start_handler
        from bot.plugins.start_handler import user_stats_callback
        ...
        await user_stats_callback(client, fake_query)
