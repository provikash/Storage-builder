...
"""
Admin commands plugin for bot administration
"""
...
async def user_stats(client: Client, message: Message):
    ...
    try:
        ...
        from bot.database.users import get_users_count, get_total_users
        
        total_users = await get_total_users()
        active_users = await get_users_count()
        ...
        await message.reply_text("❌ Error retrieving user statistics.")
...
async def ban_user(client: Client, message: Message):
    ...
    try:
        ...
        # Add to banned users (implement in database)
        from bot.database.users import ban_user_db
...
async def unban_user(client: Client, message: Message):
    ...
    try:
        ...
        from bot.database.users import unban_user_db
